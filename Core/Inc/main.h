...
#define GYRO_INT1_Pin GPIO_PIN_4
#define GYRO_INT1_GPIO_Port GPIOC
#define GYRO_INT2_Pin GPIO_PIN_0
...
#define GI2C3_SCL_Pin GPIO_PIN_8
#define GI2C3_SCL_GPIO_Port GPIOA
#define GI2C3_SDA_Pin GPIO_PIN_11
#define GI2C3_SDA_GPIO_Port GPIOC
